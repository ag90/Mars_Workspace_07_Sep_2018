...
public class Mouse_Handling {
	...
	public void handling() throws InterruptedException, AWTException{
	    ...
	    act.contextClick(driver.findElement(By.xpath("//li[contains(@class,'menu-link-block')]//a[contains(text(),'License')]"))).build().perform();
	  
		act.doubleClick(driver.findElement(By.xpath("//div[@id='treebox2']//span[contains(text(),'Books')]"))).build().perform();
